...
?>
  ...
  <body>
    ...
    <h4 class='center-text codeText'>DELETE</h4>
    ...
    <div class="container">
      ...
      <form id='deleteForm'>
        ...
        <div class="form-group">
          <label for="tabloSecDelete">
            <h5>Tablo Seçin</h5>
          </label>
          <select class="form-control" id="tabloSecDelete">
        ...
        <h4>Sorgu: <span class="codeText" id='deleteFromText' style='color: red;'>DELETE FROM</span>
          <span class='codeText' id='sorguDelete'></span>
        </h4>
        <div style='margin-top: 15px;' class="whereColumn">
          <h5 class='codeText'style='visibility:hidden; display: inline;color: red;margin-left: 78px;' id='whereForDeleteText'> WHERE </h5>
