...
<body>
  ...
  <h4 class='center-text'>Serbest Uygulama</h4>

  <div class="container">
    <form id='serbestUygulamaForm'>
    <div class="form-group">
    <label for="textSorguSerbest"><h5>Sorgu Yazın</h5></label>
    <textarea class="form-control" id="textSorguSerbest" rows="5">
    </textarea>
  </div>
    <button type="submit" class="btn btn-secondary btn-block">Sorgula</button>
    </form>

    <div id="responseGeneratedTableSerbest">
